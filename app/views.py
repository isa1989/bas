...
from app.models import Category, Product, CartItem, Cart, Order, Brand
...
def haqqimizda_view(request):
    return render(request, 'haqqimizda.html', )


def elaqe_view(request):
...
def mehsul(request):
    ...
    return render(request, 'mehsul.html', context)